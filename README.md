...
### 2. Open the CTMC model 
There are two files of the CTMC model in the code folder. To run the CTMC model, you have to open the file DownUpStreams_Noattack.pm to take the results of no attack case scenario or the file DownUpStreams_Attack.pm to take the results of attack case scenario following the path: Model-> Open model.

### 3. Open the Properties file
At this step open the epon.pctl file from the code folder to show the properties list following the path: Properties-> Open properties list.
