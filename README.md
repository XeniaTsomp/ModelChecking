...
### 2. Open the CTMC model
There are two files in the code folder which correspond to no attack and attack cases of the CTMC model. To run the CTMC model, you have to select from the code folder the file "DownUpStreams_Noattack.pm" to take the results of no attack case scenario or the file "DownUpStreams_Attack.pm" to take the results of attack case scenario. Follow the path "Model-> Open model" to open the selected file.
