...
For the attack case scenario open the prism software again and open the models' file of the attack case scenario "DownUpStreams_Attack.pm" to run the same experiment as described before, but taking care of the definition of the intervention rate value. 
